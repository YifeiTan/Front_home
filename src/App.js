                        ...
                        <div className="container">
                            ...
                            <div className="col-md-12 col-sm-12 bg_white">
                                <div id="col2" className="col-md-12 col-sm-12 picture_height2">
                                    <img src={main2} alt=""/>
                                    <h1 className="main_picture_text">DETENDEZ-VOUS </h1>
                                    <h1 className="main_picture_text2"> AVEC ELEGANCE</h1>
                                    <h4 className="main_picture_text3">Des essentiels d'inspiration athlétique
                                        pour </h4>
                                    <h4 className="main_picture_text4">rehausser votre look du week-enf</h4>
